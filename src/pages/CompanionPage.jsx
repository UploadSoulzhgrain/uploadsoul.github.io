    ...
    <div className="bg-[#f8f7f6] font-display text-[#1b130d] selection:bg-[#ee7c2b]/30 min-h-screen">
      ...
      <div className="relative flex h-auto min-h-screen w-full flex-col overflow-x-hidden">
        <div className="layout-container flex h-full grow flex-col">
          {/* Top Navigation Bar */}
          <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-[#f3ece7] px-10 py-4 bg-[#f8f7f6]/80 backdrop-blur-md sticky top-0 z-50">
            <div className="flex items-center gap-4 text-[#1b130d]">
              <div className="text-[#ee7c2b]">
                <span className="material-symbols-outlined text-4xl">cloud_upload</span>
              </div>
              <h2 className="text-[#1b130d] text-2xl font-black leading-tight tracking-tight">UploadSoul</h2>
            </div>
            ...
            <div className="flex items-center gap-4">
              <button onClick={() => navigate(l('/login'))} className="flex min-w-[84px] cursor-pointer items-center justify-center rounded-xl h-10 px-5 bg-[#ee7c2b] text-white text-sm font-bold transition-all hover:brightness-110 active:scale-95">
                登录
              </button>
              <button onClick={() => navigate(l('/register'))} className="flex min-w-[84px] cursor-pointer items-center justify-center rounded-xl h-10 px-5 bg-[#f3ece7] text-[#1b130d] text-sm font-bold transition-all hover:bg-orange-100">
                注册
              </button>
              <div className="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10 border-2 border-[#ee7c2b]/20" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuB5ef5A6eNoezS7rWznk-S3Q-_CdCy9pgtvh6Xn9cLe-OhlztxMkRCCfzdKZARy7XoCvhcBvQZoTzeoVyCR00h4qYRe7unuy9JVMSWSsy3rv14q_fdUnI_M2dHxetwg9GB8yG24Ijv965bJ8U2Q4nlf16gIleWW62eg_V9xOf5LJ5E8l-34yqbpYV9cJd9q7O7tsQ6BQaaYxtpsYN9a4JJPZ-2J58Ihx6LcU3i11NJz53uZMOIurZUIoJnV66hGp23AhDYmxHXcCmg")' }}></div>
            </div>
          </header>
          ...
          <main className="flex-1">
              ...
              <div className="flex flex-col gap-10 lg:flex-row items-center">
                <div className="flex flex-col gap-8 lg:w-1/2">
                  <div className="flex flex-col gap-4">
                    <span className="text-[#ee7c2b] font-bold tracking-widest uppercase text-sm bg-[#ee7c2b]/10 w-fit px-3 py-1 rounded-full">AI 驱动 · 情感链接</span>
                    <h1 className="text-[#1b130d] text-5xl font-black leading-tight tracking-tight lg:text-6xl">
                      开启<br /><span className="text-[#ee7c2b]">情感陪伴</span>新纪元
                    </h1>
                    <p className="text-[#9a6c4c] text-lg font-normal leading-relaxed max-w-[500px]">
                      基于先进的深度学习技术，为您打造懂你、暖你、更爱你的数字伙伴。全天候的温柔倾听，让每颗孤独的心都有归宿。
                    </p>
                  </div>
                  <div className="flex gap-4">
                    <button className="flex min-w-[180px] cursor-pointer items-center justify-center rounded-xl h-14 px-8 bg-[#ee7c2b] text-white text-lg font-bold shadow-lg shadow-[#ee7c2b]/20 hover:translate-y-[-2px] transition-transform">
                      立即开启体验
                    </button>
                  </div>
                </div>
                <div className="lg:w-1/2 w-full">
                  <div className="relative">
                    ...
                    <div className="relative w-full aspect-[4/3] bg-center bg-no-repeat bg-cover rounded-3xl shadow-2xl overflow-hidden border-8 border-white" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCLfHipGWyL6MuMpdoHUL5vEuaOVT-0dQe8MF37tjo6sBTGp9AqauOk4IjyFjHikNNDvE4wBOAVGCjVR42e45uaS5k-uvDkmOWl9DPUj5N6AhfvhTvI7MXrobWsE3Ll65HvBisorFk64p9QhKki6s01AnvpKZ7ilXcrcbsTWKo4_hW4uncRFluCN4MSR4pBh1ixUtY5aXlslIyCp4MyX_CyDxAwkFcmJ0h8SECU--yQFQUsbNrSwA2BAciNMjFd_MniZfvE8XrcJpY")' }}></div>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="bg-[#f3ece7]/30 py-20">
              <div className="max-w-[1280px] mx-auto px-10">
                <div className="text-center mb-16">
                  <h2 className="text-[#1b130d] text-4xl font-black mb-4">三大核心服务领域</h2>
                  <p className="text-[#9a6c4c] text-lg">全场景覆盖，满足不同阶段的情感需求</p>
                </div>
            ...
            <section className="max-w-[1280px] mx-auto px-10 py-20">
              <div className="flex flex-col gap-12">
                <div className="flex flex-col gap-4 max-w-[800px]">
                  <h2 className="text-[#1b130d] text-4xl font-black leading-tight">为什么选择 UploadSoul</h2>
                  <p className="text-[#9a6c4c] text-lg font-normal leading-normal">我们不仅仅是代码，更是有温度的数字存在。每一行算法都为您的幸福感而优化。</p>
                </div>
          ...
          {/* Footer Section */}
          <footer className="bg-[#1b130d] text-white pt-20 pb-10">
            <div className="max-w-[1280px] mx-auto px-10">
