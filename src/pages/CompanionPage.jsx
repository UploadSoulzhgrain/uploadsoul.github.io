    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-2xl font-semibold mb-4">{t('home.features.emotionalCompanion.title')}</h2>
          <p className="text-gray-600">{t('home.features.emotionalCompanion.description')}</p>
        </div>
      </div>
