                            ...
                            <div className="col-span-12 lg:col-span-8 space-y-8">
                                ...
                                <div className="bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                                        {[
                                            { name: '大勇 - 运动伙伴', info: '康复运动引导', status: '在线', color: 'green', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDq1NVPf89AfFfiASe4SAG09VifaQkWhv5Oiy2ddZvUHyk7xebyt3M0kj-StrJbcXx43ap6o6806zzny6VR19f-QGAf5ETtRTdLJZwvpMsigOtORrLk355N_DIducVREvagjPMD5Yi8h8iFyQFdowBkYUcQxWZXC3jXj2pi4CjD-o8z5mNYOSlldLMmrkN1jgc0RFShFxxaytqOZFygt_uPCH5O1tAK5Ttmmti5yvTXCC7oV645qlCJ5d2Yb7PQzSNJ8vZ-j11hdA4' },
                                            { name: '小珍 - 生活助理', info: '日常用药提醒', status: '在线', color: 'green', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuC6UuVLp9vSOTHQDHekslOMZToloBLb89FgWKIlOcq1tcq7Rvhaed68EVZp8pD5L1ffw56Drd6J1DI-zIlyWtcwM4FZ4l3Bc6gyLexRrldoZVgD6JobPxisWNBKY2br1cw0FQ0B_1Q9bq-eDrAgd_ec_C7AJYSN6THOU8x6Rbi-xpEiUndwnu_qtQ-663xQLb1EvOet7-Pl0tCmoH07-0rE1N6a1iLCXxICQQrOmJcIrbVnCa8NDX0t6DT1bd_pB7-LFq7DG7iVTqk' },
                                            { name: '慧阿姨 - 情感倾谈', info: '心理疏导与交流', status: '忙碌', color: 'yellow', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDM_kPOz3M2zVqNtaa2bJ3ovJkxR-nZupWlBXte1cgpLgvpeDehv-WcPfEHXXKf-IDX65kLDFZ1l6x7Y5Gk1KUM_oadfk8ecEkiscPO7jLgtP_MNHKrxRVe4ssBhDqfvv-GixGSm_cQvX8zuhp7gbbW1b6XfRVSpOEiMjqzD-KuEBiBebHx97bwBLSs3isXY6s2Fl4yaQdpbMqgDgQgnJYjvXjUNj__yedxt0GkEB4CrJXNBRvFw_mLxkGfzca3jbjOd7gAcvaucOw' }
                                        ].map((companion, idx) => (
                                            <div key={idx} className="bg-slate-50 dark:bg-slate-900/50 p-6 rounded-2xl text-center border-2 border-transparent hover:border-[#ee7c2b] transition-all group">
                    ...
                    <footer className="mt-20 border-t border-[#ee7c2b]/10 py-12 px-10 bg-slate-50 dark:bg-slate-900/50">
                        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
                            ...
                            <div className="flex flex-wrap justify-center gap-12 text-slate-400 font-bold">
                                ...
                                <a className="hover:text-[#ee7c2b] transition-colors" href="#contact">联系管理中心</a>
                                <a className="hover:text-[#ee7c2b] transition-colors" href="#support">技术支持: 400-888-9999</a>
                            </div>
                        </div>
                    </footer>
                </div>
